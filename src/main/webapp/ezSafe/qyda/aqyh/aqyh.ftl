<link rel="stylesheet" type="text/css" href="<@spring.url '/ezSafe/qyda/aqyh/aqyh.css'/>"/>
...
<div id="aqyhWindow" style="display: none">
        <#include "/ezSafe/qyda/aqyh/details/xcrwEdit.ftl">
</div>

<div id="aqyhdetil-window" style="display: none">
        <#include "/ezSafe/qyda/aqyh/details/aqyhDetail.ftl">
</div>
