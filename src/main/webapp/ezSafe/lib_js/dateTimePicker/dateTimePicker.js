				...
				.on('xchange.xdsoft', function (event) {
					...
					xchangeTimer = setTimeout(function () {
						...
						line_time = function line_time(h, m) {
							...
							classes = [];
                            var a = _xdsoft_datetime.strtotime(options.maxTime);
                            var b = _xdsoft_datetime.strtotime(options.minTime);
                            var c = now;
                            var i = a.getHours() * 60 * 60 + a.getMinutes() * 60 + a.getSeconds();
                            var j = b.getHours() * 60 * 60 + b.getMinutes() * 60 + b.getSeconds();
                            var k = c.getHours() * 60 * 60 + c.getMinutes() * 60 ;
                            if ((options.minDateTime !== false && options.minDateTime > optionDateTime) || (options.maxTime !== false && i < k) || (options.minTime !== false && j > k)) {
								classes.push('xdsoft_disabled');
			...
			timebox
				...
				.on('touchend click.xdsoft', 'div', function (xdevent) {
					if (!this.touchMoved) {
						...
						datetimepicker.data('input').val(_xdsoft_datetime.str().substr(0,_xdsoft_datetime.str().length-2)+"00");
